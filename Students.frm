...
Begin VB.Form Students 
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.ComboBox Combo2 
         Height          =   315
         ItemData        =   "Students.frx":0000
         Left            =   4680
         List            =   "Students.frx":0019
         TabIndex        =   31
         Top             =   240
         Width           =   2175
      End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox Combo1 
         ...
         DataSource      =   "Adodc1"
         Height          =   315
         ItemData        =   "Students.frx":005A
         Left            =   3360
         List            =   "Students.frx":0064
         TabIndex        =   15
         Top             =   1920
         Width           =   2775
      End
...
Private Sub Command1_Click()
    ...
    Select Case Field
        ...
        Case Else
            Field = "Gender"
    End Select
    sql = "select * from Students where " & Field & " like '%" & Text9.Text & "%'"
    If (Text9 <> "") Then
...
Private Sub Command3_Click()
    ...
    Adodc1.Recordset.Fields(4).Value = Text3.Text
    Adodc1.Recordset.Fields(5).Value = Text4.Text
    Adodc1.Recordset.Fields(6).Value = Text5.Text
    Adodc1.Recordset.Fields(7).Value = Text6.Text
    Adodc1.Recordset.Fields(3).Value = Combo1.Text
